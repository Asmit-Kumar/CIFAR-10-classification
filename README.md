...
## CIFAR-100 — [12 notebooks](notebooks/cifar_100/)
...
**Key finding:** Scaling from EfficientNet-B0 → B3 from scratch yields almost no gain (~78% both). The bottleneck is data, not model capacity. Transfer learning consistently breaks the ceiling.

---

## ImageNet-100 — [5 notebooks](notebooks/imagenet_100/)
...
| 5 | ResNet-34 — interpolation study | Transfer | 85.77% | 85.89% |

Notebook 5 systematically compares Bilinear / Bicubic / Lanczos upscaling on CIFAR-100 images before a pretrained ResNet-34 — investigating whether interpolation choice meaningfully affects accuracy. (Spoiler: Lanczos edges out, but the gap is small.)
...
│   │   └── README.md
│   ├── cifar_100/          # 12 notebooks — scratch ceiling, TL, EfficientNet
│   │   └── README.md
│   └── imagenet_100/       # 5 notebooks — full-res, ConvNeXt, interpolation study
│       └── README.md
...
├── scripts/                # Utility scripts (notebook patching, migration)
